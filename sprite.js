...
s_numberB;
// globle variables
//ref to img and position height and width
...
Sprite.prototype.draw = function(ctx, x, y) { //first source vars then draw vars
...
function initSprites(img) {
	...
	//assigns every var an image from the sprite
	s_bird = [
	...
	//ye kya backchodi hai samjaho koi
	s_numberS.draw = s_numberB.draw = function(ctx, x, y, num,center,offset) {
		num = num.toString();
		//console.log(num);//bc num kya hai ye
		//console.log(this.width); //jab chalega tab pata pad jayega 
